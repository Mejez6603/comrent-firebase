...
- **Permission Denied:** Our first attempts to `git push` were rejected because the cached credentials of the old account (`Mejez6603`) did not have permission to access the new repository (`mejezstudio-bit/comrent-firebase.git`).
...
Ensure you have the system requirements listed above.

### Installation

1.  **Clone the repository:**
    ```bash
    git clone https://github.com/Mejez6603/comrent-firebase.git
    cd comrent-firebase
    ```
